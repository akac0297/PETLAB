...
img_B50,img_DCE_1,img_T2 = readMRIs(input_path,patient_list[0],timepoints[0])
img=img_T2
new_img=img_B50
...
tfm_img_rigid=sitk.ReadTransform(path+"WES_0"+patient_id+"_"+img_type+"_TIMEPOINT_"+timepoint+"_to_"+new_img_type+"_TIMEPOINT_"+timepoint+"_rigid.txt") 
tfm_img_affine=sitk.ReadTransform(path+"WES_0"+patient_id+"_"+img_type+"_TIMEPOINT_"+timepoint+"_to_"+new_img_type+"_TIMEPOINT_"+timepoint+"_affine.txt")
...
sitk.WriteImage(mask_rigid, "/home/alicja/PET-LAB Code/MRI_transforms/test_rigid_mask.nii.gz")
