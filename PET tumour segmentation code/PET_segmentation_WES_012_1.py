...
ct="WES_012_1_20181026_CT_10_PETCT_WBHDIN_ONC_3.nii.gz"
pet="WES_012_1_20181026_PT_AC_4.nii.gz"
ct_plan="WES_012_3_20190404_CT_3.nii.gz"
breast_struct="WES_012_3_0_RTSTRUCT_WHOLE_BREAST_CTV.nii.gz" #if present
...
breast_contour_dilate=sitk.BinaryDilate(contour_breast_plan_to_0_dir, (2,0,0)) #if using different structure
...
breast_contour_dilate=sitk.ReadImage("breast_contour_dilate_"+patient_no+"_"+timepoint+".nii.gz")
