...
filenameB50T_1="WES_008_6_20181214_MR_EP2D_DIFF_TRA_SPAIR_ZOOMIT_EZ_B50T_EP2D_DIFF_TRA_SPAIR_ZOOMIT_TRACEW_DFC_MIX_6.nii.gz"
filenameB800T_1="WES_008_6_20181214_MR_EP2D_DIFF_TRA_SPAIR_ZOOMIT_EZ_B800T_EP2D_DIFF_TRA_SPAIR_ZOOMIT_TRACEW_DFC_MIX_6.nii.gz"
filenameT2w_1="WES_008_6_20181214_MR_T2_TSE_TRA_SPAIR_TSE2D1_11_T2_TSE_TRA_SPAIR_3.nii.gz"
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=530, upperthreshold=5000, hole_size=1)
...
fig, ax = plt.subplots(1,1)
ax.hist(values, bins=np.linspace(1,550,50), histtype='stepfilled', lw=2)
ax.grid()
ax.set_axisbelow(True)
ax.set_xlabel('Intensity')
ax.set_ylabel('Frequency')
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=320, upperthreshold=5000, hole_size=1)
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=120, upperthreshold=500, hole_size=1)
