...
filenameB50T_1="WES_013_4_20181114_MR_EP2D_DIFF_TRA_SPAIR_ZOOMIT_EZ_B50T_EP2D_DIFF_TRA_SPAIR_ZOOMIT_TRACEW_DFC_MIX_5.nii.gz"
filenameB800T_1="WES_013_4_20181114_MR_EP2D_DIFF_TRA_SPAIR_ZOOMIT_EZ_B800T_EP2D_DIFF_TRA_SPAIR_ZOOMIT_TRACEW_DFC_MIX_5.nii.gz"
filenameT2w_1="WES_013_4_20181114_MR_T2_TSE_TRA_SPAIR_TSE2D1_11_T2_TSE_TRA_SPAIR_3.nii.gz"
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=340, upperthreshold=5000, hole_size=1)
...
fig, ax = plt.subplots(1,1)
ax.hist(values, bins=np.linspace(1,450,50), histtype='stepfilled', lw=2)
ax.grid()
ax.set_axisbelow(True)
ax.set_xlabel('Intensity')
ax.set_ylabel('Frequency')
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=170, upperthreshold=5000, hole_size=2)
...
label_threshold_cc = sitk.RelabelComponent(sitk.ConnectedComponent(new_seg_1_1))
new_seg=(label_threshold_cc==1)


# In[27]:


vis=ImageVisualiser(new_seg, cut=get_com(new_seg), window=[0,1])
fig=vis.show()
...
sitk.WriteImage(new_seg,"new_seg_0"+pat_no+"_"+timept+"_mri.nii.gz")
