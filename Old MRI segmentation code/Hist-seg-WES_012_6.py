...
filenameB50T_1="WES_012_6_20190227_MR_EP2D_DIFF_TRA_SPAIR_ZOOMIT_EZ_B50T_EP2D_DIFF_TRA_SPAIR_ZOOMIT_TRACEW_DFC_6.nii.gz"
filenameB800T_1="WES_012_6_20190227_MR_EP2D_DIFF_TRA_SPAIR_ZOOMIT_EZ_B800T_EP2D_DIFF_TRA_SPAIR_ZOOMIT_TRACEW_DFC_6.nii.gz"
filenameT2w_1="WES_012_6_20190227_MR_T2_TSE_TRA_SPAIR_TSE2D1_11_T2_TSE_TRA_SPAIR_4.nii.gz"
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=1120, upperthreshold=5000, hole_size=1)
...
arr_mri = sitk.GetArrayFromImage(image_mri)
arr_mri[:,:,146:] = 0 #if lat is L
arr_mri[:,:,:116] = 0 
image_mri_masked=sitk.GetImageFromArray(arr_mri)
image_mri_masked.CopyInformation(image_mri)

label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=600, upperthreshold=5000, hole_size=2)
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=190, upperthreshold=5000, hole_size=1)
