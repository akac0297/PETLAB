...
breast=sitk.ReadImage("/home/alicja//Downloads/PET-LAB Nifti files/L-breast.nii.gz") #left breast
#Left breast=sitk.ReadImage("contralateral_segmentation.nii.gz")

pat_no="07"
timept="4"

WES_1_B50T=sitk.ReadImage("/home/alicja/PET_LAB_PROCESSED/WES_005/IMAGES/WES_005_TIMEPOINT_1_MRI_DWI_B50.nii.gz")
...
fig.savefig(f"/home/alicja/PET_LAB_PROCESSED/dir_contour_005.jpeg",dpi=400)

breast_contour_dilate=sitk.BinaryDilate(breast_to_0_dir, (2,0,2))

arr_mri = sitk.GetArrayFromImage(breast_contour_dilate)
...
image_mri_masked.CopyInformation(breast_contour_dilate)
breast_contour_dilate=image_mri_masked

vis = ImageVisualiser(WES_1_B50T, axis='z', cut=get_com(breast_to_0_dir), window=[-50, 700])
vis.add_contour(breast_contour_dilate, name='BREAST', color='g')
fig = vis.show()

fig.savefig(f"/home/alicja/PET_LAB_PROCESSED/dir_dilate_contour_005.jpeg",dpi=400)

sitk.WriteImage(breast_contour_dilate,"/home/alicja/PET_LAB_PROCESSED/breast_contour_dilate_005_4.nii.gz")
...
sitk.WriteImage(label_threshold_cc_x_f,"/home/alicja/PET_LAB_PROCESSED/WES_005_tumour_seg.nii.gz")
