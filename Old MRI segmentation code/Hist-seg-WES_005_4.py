...
filenameB50T_1="WES_005_4_20170717_MR_RESOLVE_DIFF_TRA_SPAIR_P2_RE_B50T_RESOLVE_DIFF_TRA_SPAIR_P2_TRACEW_6.nii.gz"
filenameB800T_1="WES_005_4_20170717_MR_RESOLVE_DIFF_TRA_SPAIR_P2_RE_B800T_RESOLVE_DIFF_TRA_SPAIR_P2_TRACEW_6.nii.gz"
filenameT2w_1="WES_005_4_20170717_MR_T2_TSE_TRA_SPAIR_TSE2D1_11_T2_TSE_TRA_SPAIR_3.nii.gz"
...
breast_contour_dilate=sitk.BinaryDilate(breast_to_0_dir, (25,25,35))
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=1500, upperthreshold=5000, hole_size=1)
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=800, upperthreshold=5000, hole_size=1)
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=150, upperthreshold=5000, hole_size=1)
...
arr_mri = sitk.GetArrayFromImage(image_mri)
arr_mri[:,:,:arr_mri.shape[2]//2] = 0 #if lat is L
arr_mri[:,arr_mri.shape[1]//2+20:,:] = 0
image_mri_masked=sitk.GetImageFromArray(arr_mri)
image_mri_masked.CopyInformation(image_mri)
