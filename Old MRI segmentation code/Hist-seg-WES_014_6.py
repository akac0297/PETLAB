...
filenameB50T_1="WES_014_6_20190510_MR_RESOLVE_DIFF_TRA_SPAIR_P2_RE_B50T_RESOLVE_DIFF_TRA_SPAIR_P2_TRACEW_6.nii.gz"
filenameB800T_1="WES_014_6_20190510_MR_RESOLVE_DIFF_TRA_SPAIR_P2_RE_B800T_RESOLVE_DIFF_TRA_SPAIR_P2_TRACEW_6.nii.gz"
filenameT2w_1="WES_014_6_20190510_MR_T2_TSE_TRA_SPAIR_TSE2D1_11_T2_TSE_TRA_SPAIR_3.nii.gz"
...
ax.hist(values, bins=np.linspace(1,2500,50), histtype='stepfilled', lw=2)
ax.grid()
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=1765, upperthreshold=5000, hole_size=1)
...
fig, ax = plt.subplots(1,1)
ax.hist(values, bins=np.linspace(1,1750,50), histtype='stepfilled', lw=2)
ax.grid()
ax.set_axisbelow(True)
ax.set_xlabel('Intensity')
ax.set_ylabel('Frequency')
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=720, upperthreshold=5000, hole_size=1)
