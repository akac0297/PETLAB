...
filenameB50T_1="WES_008_4_20180619_MR_EP2D_DIFF_TRA_SPAIR_ZOOMIT_EZ_B50T_EP2D_DIFF_TRA_SPAIR_ZOOMIT_TRACEW_DFC_MIX_5.nii.gz"
filenameB800T_1="WES_008_4_20180619_MR_EP2D_DIFF_TRA_SPAIR_ZOOMIT_EZ_B800T_EP2D_DIFF_TRA_SPAIR_ZOOMIT_TRACEW_DFC_MIX_5.nii.gz"
filenameT2w_1="WES_008_4_20180619_MR_T2_TSE_TRA_SPAIR_TSE2D1_11_T2_TSE_TRA_SPAIR_3.nii.gz"
...
ax.hist(values, bins=np.linspace(1,2000,50), histtype='stepfilled', lw=2)
ax.grid()
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=1100, upperthreshold=5000, hole_size=1)
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=450, upperthreshold=5000, hole_size=1)
...
fig, ax = plt.subplots(1,1)
ax.hist(values, bins=np.linspace(1,500,50), histtype='stepfilled', lw=2)
ax.grid()
ax.set_axisbelow(True)
ax.set_xlabel('Intensity')
ax.set_ylabel('Frequency')
...
label_threshold_cc_x_f=estimate_tumour_vol(image_mri_masked, lowerthreshold=165, upperthreshold=5000, hole_size=1)
